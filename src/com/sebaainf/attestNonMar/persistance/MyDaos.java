...
public class MyDaos {
     ...
     * for h2        ;MV_STORE=FALSE;MVCC=FALSE
     */

    static String driver = "org.h2.Driver";
    static String database = "dbattest_nm";
     ...
     */
    public static List<Attest> getListAttest(String nom, String prenom, boolean inFrench) throws PersistenceException {
